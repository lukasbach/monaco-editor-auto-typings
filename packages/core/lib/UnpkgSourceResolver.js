...
var UnpkgSourceResolver = /** @class */ (function () {
    ...
    UnpkgSourceResolver.prototype.resolvePackageJson = function (packageName, version) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resolveFile("https://unpkg.com/" + packageName + (version ? "@" + version : '') + "/package.json")];
    ...
    UnpkgSourceResolver.prototype.resolveSourceFile = function (packageName, version, path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resolveFile("https://unpkg.com/" + packageName + (version ? "@" + version : '') + "/" + path)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
